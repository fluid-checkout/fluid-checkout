			...
			$settings = apply_filters(
				...
				array(
					...
					array(
						...
						'desc_tip'          => __( 'When enabled, the first shipping method available will not be automatically selected when no other shipping method was previously selected for each shipping package.', 'fluid-checkout' ),
					...
					array(
						'desc'              => __( 'Show option to clear shipping methods', 'fluid-checkout' ),
						'desc_tip'          => __( 'Show a link button on the pickup location substep to clear the chosen shipping methods. This can be used to allow showing the shipping address section again if a local pickup method was previously selected. <br>The option "Shipping methods > Prevent automatic selection of the first shipping method" will be automatically enabled when this option is enabled.', 'fluid-checkout' ),
