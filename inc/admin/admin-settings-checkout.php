			...
			$settings = apply_filters(
				...
				array(
					...
					array(
						...
						'desc'              => __( 'General styles for the checkout steps, order summary and other sections. Maybe also apply to other pages such as the Cart, Order Received and View Order pages.', 'fluid-checkout' ) . FluidCheckout_Admin::instance()->get_upgrade_pro_html(),
