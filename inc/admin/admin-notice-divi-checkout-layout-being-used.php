	...
	public function add_notice( $notices = array() ) {
		...
		$notices[] = array(
			...
			'actions'        => array(
				...
				sprintf( '<a href="%s" class="button button-secondary">%s</a>', 'https://fluidcheckout.com/docs/getting-started-fluid-checkout/#shortcode-vs-divi-builder', __( 'Read the documentation.', 'fluid-checkout' ) ),
			),
		);
