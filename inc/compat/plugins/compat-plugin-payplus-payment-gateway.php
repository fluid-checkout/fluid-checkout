...
class FluidCheckout_PayplusPaymentGateway extends FluidCheckout {
	...
	public function register_assets() {
		// Checkout events
		wp_register_script( 'fc-compat-payplus-payment-gateway-checkout', FluidCheckout_Enqueue::instance()->get_script_url( 'js/compat/plugins/payplus-payment-gateway/compat-payplus-checkout' ), array( 'jquery', 'wc-checkout' ), NULL, array( 'in_footer' => true, 'strategy' => 'defer' ) );
