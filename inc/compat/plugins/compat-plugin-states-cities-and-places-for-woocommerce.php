...
class FluidCheckout_StatesCitiesAndPlacesForWooCommerce extends FluidCheckout {
	...
	public function register_assets() {
		// Scripts
		wp_register_script( 'wc-city-select', self::$directory_url . 'js/compat/plugins/states-cities-and-places-for-woocommerce/place-select' . self::$asset_version . '.js', array( 'jquery', 'woocommerce' ), NULL );
	}
