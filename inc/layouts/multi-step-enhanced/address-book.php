...
class FluidCheckout_AddressBook extends FluidCheckout {
	...
	public function hooks() {
		...
		// Address Form
		add_action( 'wp_enqueue_scripts', array( $this, 'enqueue_replace_address_scripts' ), 5 ); // Need to run before WooCommerce registers and enqueues the script `wc-checkout`
		add_action( 'wp_enqueue_scripts', array( $this, 'enqueue_replace_checkout_scripts' ), 5 ); // Need to run before WooCommerce registers and enqueues the script `wc-checkout`
