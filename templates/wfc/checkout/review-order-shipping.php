...
<tr class="woocommerce-shipping-totals shipping">
	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		...
		<?php else :
			...
			echo wp_kses_post( apply_filters( 'wfc_checkout_no_shipping_method_chosen_html', sprintf( esc_html__( '--', 'woocommerce' ) . ' ', '<strong>' . esc_html( $formatted_destination ) . '</strong>' ) ) );
		endif; ?>
	</td>
</tr>
