...
(function(){
    ...
    RequireBundle.register( 'wfc-checkout-gift-options', [ settings.jsPath + 'checkout-gift-options' + ver + '.js', settings.cssPath + 'checkout-gift-options' + ver + '.css' ], '.has-wfc-gift-options #woocommerce-gift-options__field-wrapper', function(){ CheckoutGiftOptions.init(); } );
