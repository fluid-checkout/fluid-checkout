...
* Improved: Partial compatibility with plugin States, Cities, and Places for WooCommerce. Update field options and add support for TomSelect dropdown components.
