...
* Improved: Compatibility with Shoptimizer theme, completely and only remove the coupon code section at bottom of the page when integrated coupon code feature is enabled.
