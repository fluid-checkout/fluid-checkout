...
* **[Google Address Autocomplete for WooCommerce](https://fluidcheckout.com/product/fc-google-address-autocomplete/)**: let customers search their addresses and autofill fields in the checkout page using the Google APIs, reducing by around 40% the number of fields they need to type. [Also available as a stand-alone plugin](https://fluidcheckout.com/product/fc-google-address-autocomplete/).
