...
* **Google Address Autocomplete for WooCommerce**: let customers search their addresses and autofill fields in the checkout page using the Google APIs, reducing by around 40% the number of fields they need to type. [Also available as a stand-alone plugin](https://fluidcheckout.com/fc-google-address-autocomplete/).
...
* Improved: Compatibility with theme Flatsome, correctly recover field focus when updating checkout fragments if the theme feature Float Labels is activated.
