...
(function (root, factory) {
	...
	var _settings = {
		...
		validClass:                              'fc-inline-validated',
		invalidClass:                            'fc-inline-invalid',
	...
	var addInlineMessage = function( field, formRow, message, invalidClass ) {
		...
		element.className = 'fc-inline-error invalid-' + invalidClass;
	...
	var removeInlineMessage = function( field, formRow, invalidClass ) {
		var messageElements = formRow.querySelectorAll( 'span.fc-inline-error.invalid-' + invalidClass );
