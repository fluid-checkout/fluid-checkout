...
{
	jQuery(document).on('change','#billing_eu_vat',wcev_validate_field_and_remove_tax);
	jQuery(document).on('change','#billing_it_sid_pec, #billing_it_codice_fiscale, #billing_es_nif_nie', wcev_force_validation);
